...
HRESULT CLibInterface::CycleUpdate(ITcTask* ipTask, ITcUnknown* ipCaller, ULONG_PTR context)
{
	...
	ReadFromPLC();
	robot.DecoderInstruct(instruct, indexCrl,velo,pos,veloX,veloY,veloZ);     //解码函数2，命令落实
...
)
{
	...
	case LibInterfaceIndexGroup2:
		...
		case LibInterfaceIndexOffset5://读取X速度
		{	m_Trace.Log(tlInfo, FNAMEA "oid=0x%08x indexGroup=0x%08x, indexOffset=0x%08x",
			m_objId.value, indexGroup, indexOffset);
		...
		AdsReadWriteRes(rAddr, invokeId, ADSERR_NOERR, sizeof(double), pData); }
			break;
		case LibInterfaceIndexOffset6://读取X速度
		{m_Trace.Log(tlInfo, FNAMEA "oid=0x%08x indexGroup=0x%08x, indexOffset=0x%08x",
			m_objId.value, indexGroup, indexOffset);
		...
		case LibInterfaceIndexOffset7://读取Z速度
		{	m_Trace.Log(tlInfo, FNAMEA "oid=0x%08x indexGroup=0x%08x, indexOffset=0x%08x",
			m_objId.value, indexGroup, indexOffset);
...
void CLibInterface::ReadFromPLC()
{
	...
	robot.arm.SwingArm[0].AxisStatus.position = m_Inputs.SwingArm1Output.Position;
	...
	robot.arm.SwingArm[1].AxisStatus.position = m_Inputs.SwingArm2Output.Position;
	robot.arm.SwingArm[1].AxisStatus.velocity = m_Inputs.SwingArm2Output.Velocity;

	robot.arm.SwingArm[2].AxisStatus.Enable = m_Inputs.SwingArm2Output.Enable;
	robot.arm.SwingArm[2].AxisStatus.position = m_Inputs.SwingArm2Output.Position;
	robot.arm.SwingArm[2].AxisStatus.velocity = m_Inputs.SwingArm2Output.Velocity;

	robot.arm.SwingArm[3].AxisStatus.Enable = m_Inputs.SwingArm2Output.Enable;
	robot.arm.SwingArm[3].AxisStatus.position = m_Inputs.SwingArm2Output.Position;
	robot.arm.SwingArm[3].AxisStatus.velocity = m_Inputs.SwingArm2Output.Velocity;
	...
	robot.mainpulator.Mainpu[6].AxisStatus.Enable = m_Inputs.ClampOutput.Enable;
	robot.mainpulator.Mainpu[6].AxisStatus.position = m_Inputs.ClampOutput.Position;
	robot.mainpulator.Mainpu[6].AxisStatus.velocity = m_Inputs.ClampOutput.Velocity;
}
...
void CLibInterface::WriteToPLC()
{
	...
	m_Outputs.SwingArm1Input.Position = robot.arm.SwingArm[0].AxisCommand.Position;
	...
	m_Outputs.SwingArm2Input.Position = robot.arm.SwingArm[1].AxisCommand.Position;
	...
	m_Outputs.SwingArm3Input.Position = robot.arm.SwingArm[2].AxisCommand.Position;
	...
	m_Outputs.SwingArm4Input.Position = robot.arm.SwingArm[3].AxisCommand.Position;
	...
	m_Outputs.ClampInput.Enable = robot.mainpulator.Mainpu[6].AxisCommand.Enable;
	m_Outputs.ClampInput.Halt = robot.mainpulator.Mainpu[6].AxisCommand.Halt;
	m_Outputs.ClampInput.Home = robot.mainpulator.Mainpu[6].AxisCommand.Home;
	m_Outputs.ClampInput.MoveAbsolute = robot.mainpulator.Mainpu[6].AxisCommand.MoveAbsolute;
	m_Outputs.ClampInput.MoveRelative = robot.mainpulator.Mainpu[6].AxisCommand.MoveRelative;
	m_Outputs.ClampInput.MoveVelocity = robot.mainpulator.Mainpu[6].AxisCommand.MoveVelocity;
	m_Outputs.ClampInput.Position = robot.mainpulator.Mainpu[6].AxisCommand.Position;
	m_Outputs.ClampInput.Velocity = robot.mainpulator.Mainpu[6].AxisCommand.Velocity;
	m_Outputs.ClampInput.Reset = robot.mainpulator.Mainpu[6].AxisCommand.Reset;
}