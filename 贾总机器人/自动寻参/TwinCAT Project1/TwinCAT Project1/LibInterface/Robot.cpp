...
void Robot::DecoderInstruct(int instruct, int axisID, double velo, double pos, double velX, double velY, double velZ)
{
	...
	else if (instruct == 888)			//机器人站立
	{
		for (int i = 0; i < 4; i++)
		{
			arm.SwingArm[i].AxisCommand.Velocity = 3;
			arm.SwingArm[i].AxisCommand.Position = 65;
			arm.SwingArm[i].AxisCommand.MoveAbsolute = true;
		}
	}
	else if (instruct == 999)			//机器人归位
	{
		for (int i = 0; i < 4; i++)
		{
			arm.SwingArm[i].AxisCommand.Velocity = 3;
			arm.SwingArm[i].AxisCommand.Position = -90;
			arm.SwingArm[i].AxisCommand.MoveAbsolute = true;
		}
	}
	...
	{
		mainpulator.Mainpu[1].AxisCommand.Velocity = 3;
		mainpulator.Mainpu[1].AxisCommand.Position = -114.3;
		mainpulator.Mainpu[1].AxisCommand.MoveAbsolute = true;
		mainpulator.Mainpu[3].AxisCommand.Velocity = 3;
		mainpulator.Mainpu[3].AxisCommand.Position = 46.24;
		mainpulator.Mainpu[3].AxisCommand.MoveAbsolute = true;
		mainpulator.Mainpu[4].AxisCommand.Velocity = 3;
		mainpulator.Mainpu[4].AxisCommand.Position = 29.99;
		mainpulator.Mainpu[4].AxisCommand.MoveAbsolute = true;
		mainpulator.Mainpu[6].AxisCommand.Velocity = 3;
		mainpulator.Mainpu[6].AxisCommand.Position = -32;
		mainpulator.Mainpu[6].AxisCommand.MoveAbsolute = true;
	}
	else if (instruct == 15)
	{
		mainpulator.Mainpu[1].AxisCommand.Velocity = 3;
		mainpulator.Mainpu[1].AxisCommand.Position = -82;
		mainpulator.Mainpu[1].AxisCommand.MoveAbsolute = true;
		mainpulator.Mainpu[3].AxisCommand.Velocity = 3;
		mainpulator.Mainpu[3].AxisCommand.Position = 40.59;
		mainpulator.Mainpu[3].AxisCommand.MoveAbsolute = true;
		mainpulator.Mainpu[4].AxisCommand.Velocity = 3;
		mainpulator.Mainpu[4].AxisCommand.Position = 1.15;
		mainpulator.Mainpu[4].AxisCommand.MoveAbsolute = true;
	...
	{
		mainpulator.Mainpu[6].AxisCommand.Velocity = 3;
		mainpulator.Mainpu[6].AxisCommand.Position = 9.2;
		mainpulator.Mainpu[6].AxisCommand.MoveAbsolute = true;
	}
	else if (instruct == 17)
	{
		mainpulator.Mainpu[0].AxisCommand.Velocity = 2;
	...
	{
		mainpulator.Mainpu[0].AxisCommand.Velocity = 2;
		mainpulator.Mainpu[0].AxisCommand.Position = 19.4;
		mainpulator.Mainpu[0].AxisCommand.MoveAbsolute = true;
	}
	else if (instruct == 19)
	{
		mainpulator.Mainpu[1].AxisCommand.Velocity = 3;
		mainpulator.Mainpu[1].AxisCommand.Position = -40;
		mainpulator.Mainpu[1].AxisCommand.MoveAbsolute = true;
	}
