...
void Robot::CalculateHandVelo(double velX, double velY, double velZ,int instruct)
{
	{
		...
		double d = mainpulator.Mainpu[0].AxisStatus.position;
		double e = mainpulator.Mainpu[5].AxisStatus.position*1.0118 - 1.88;
		double tempa = a;
		double tempb = b;
		a = a + 90;
		b = b + tempa+90;
		...
		double tempx = 0.55*cos_(a) + 0.45*cos_(b) + 0.338*cos_(c);
		mainpulator.Mainpu[0].AxisCommand.Velocity = velZ * (1 - sin_(d)*sin_(d)) / cos_(d) / tempx;
		mainpulator.Mainpu[1].AxisCommand.Velocity = ((velX+ velZ*sin_(d))*cos_(b) + velY*sin_(b)) / (length_BigArm*sin_(b - a));
		...
		mainpulator.Mainpu[5].AxisCommand.Velocity = mainpulator.Mainpu[0].AxisCommand.Velocity;

		mainpulator.Mainpu[0].AxisCommand.Velocity = mainpulator.Mainpu[0].AxisCommand.Velocity / 90 * 27.83 / PI * 180;
		...
		mainpulator.Mainpu[5].AxisCommand.Velocity = mainpulator.Mainpu[5].AxisCommand.Velocity / 1.0118/ PI * 180;

		mainpulator.Mainpu[0].AxisCommand.MoveVelocity = true;
		...
		mainpulator.Mainpu[5].AxisCommand.MoveVelocity = true;
	}
}
void Robot::DecoderInstruct(int instruct, int axisID, double velo, double pos, double carVelX, double carVelY, double handVelX, double handVelY, double handVelZ,int &flag)
{
	...
	else if (instruct == 420)
	{
	mainpulator.Mainpu[axisID].AxisCommand.Velocity = velo;
	mainpulator.Mainpu[axisID].AxisCommand.MoveVelocity = true;
	}
	else if (instruct == 430)
	{
	mainpulator.Mainpu[axisID].AxisCommand.Velocity = velo;
	mainpulator.Mainpu[axisID].AxisCommand.MoveVelocity = true;
	}
	else if (instruct == 440)
	{
	mainpulator.Mainpu[axisID].AxisCommand.Velocity = velo;
	mainpulator.Mainpu[axisID].AxisCommand.MoveVelocity = true;
	}
	else if (instruct == 450)
	{
	mainpulator.Mainpu[axisID].AxisCommand.Velocity = velo;
	mainpulator.Mainpu[axisID].AxisCommand.MoveVelocity = true;
	}
	else if (instruct == 460)
	{
	mainpulator.Mainpu[axisID].AxisCommand.Velocity = velo;
	mainpulator.Mainpu[axisID].AxisCommand.MoveVelocity = true;
	}
	else if (instruct == 470)
	{
	mainpulator.Mainpu[axisID].AxisCommand.Velocity = velo;
	mainpulator.Mainpu[axisID].AxisCommand.MoveVelocity = true;
	}
	else if (instruct == 480)
	{
	mainpulator.Mainpu[axisID].AxisCommand.Velocity = velo;
	mainpulator.Mainpu[axisID].AxisCommand.MoveVelocity = true;
	}
